...
export class DataManager {
  ...
  static getLevelData() {
    if (this.currentLevel >= this.levelDatas.length && this.currentLevel % 2 === 0) {
      let randomIndex = Util.randomEven(4, this.levelDatas.length - 1);
      return this.levelDatas[randomIndex - 1];
    }
    else if (this.currentLevel >= this.levelDatas.length && this.currentLevel % 2 !== 0) {
      let randomIndex = Util.randomOdd(4, this.levelDatas.length - 2);
      return this.levelDatas[randomIndex - 1];
    }
