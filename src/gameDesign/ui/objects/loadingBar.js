...
export class LoadingBar extends Entity {
  constructor(data) {
    ...
    data.color = data.color || Util.createColor(82, 204, 52);
    this.increase = 0;
     this.addComponent("element", {
            type: ELEMENTTYPE_IMAGE,
            spriteAsset: AssetLoader.getAssetByKey("loading_bar_1a"),
            anchor:data.anchor,
            pivot: data.pivot,
            width: data.width,
            height: data.height,
  ...
  _initBar() {
    ...
    this.bar.addComponent("element", {
      type: ELEMENTTYPE_IMAGE,
      spriteAsset: AssetLoader.getAssetByKey("loading_bar_2"),
