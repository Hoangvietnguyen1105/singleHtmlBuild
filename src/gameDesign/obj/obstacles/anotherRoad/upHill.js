...
export class UpHill extends Entity {
    constructor() {
        super("road");
        this.addComponent("model", { asset: AssetLoader.getAssetByKey("UphillHigh") });
        this.collider = this.addScript(BoxCollider, {
            tag: CollisionTag.upHillRoad,
            render: GameConstant.DEBUG_COLLIDER,
            position: new Vec3(0, -3, -0.3),
            scale: new Vec3(10, 22, 16.13),
        });
