...
export class FallObstacle extends Entity {
    constructor() {
        super("fo");
        this.completeTweenJump = true
        this.addComponent("model", { asset: AssetLoader.getAssetByKey("Path Right") });
        this.collider = this.addScript(BoxCollider, {
            tag: CollisionTag.Jump,
            render: GameConstant.DEBUG_COLLIDER,
            position: new Vec3(4.115, 0, -4.67),
            scale: new Vec3(7, 1, 6.12),
        });
