...
export class UpHillLow extends Entity {
    constructor() {
        super("road");
        this.addComponent("model", { asset: AssetLoader.getAssetByKey("UphillLow") });
        this.collider = this.addScript(BoxCollider, {
            tag: CollisionTag.UpHillLowRoad,
            render: GameConstant.DEBUG_COLLIDER,
            position: new Vec3(0, -3, -7.3),
